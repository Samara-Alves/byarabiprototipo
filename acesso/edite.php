...
if(!empty($_GET['id']))
{
	 ...
	 $sqlselect = "SELECT * FROM cliente where usuario_id=$id";
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="editarRegistro.php" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input  class="form-control" name="nome" value="<?php echo $nome?>" disabled>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Telefone</label>
                                       <input  class="form-control" name="email" value="<?php echo $telefone?>" disabled>
                                      
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Ambientes</label>
                                       <input  class="form-control" name="email" value="<?php echo $ambientes?>" disabled>
                                      
                                </div>
                                 <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Pretenção de Investimento</label>
                                       <input  class="form-control" name="email" value="<?php echo $valor?>" disabled>
                                      
                                </div>
                                 <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Observação</label>
                                       <input  class="form-control" name="email" value="<?php echo $observacao?>" disabled>
                            ...
                            <BR>
                              ...
                              <a href="https://api.whatsapp.com/send?phone=<?php echo $telefone?>&text=Ol%C3%A1,%20tudo%20bem?%0AMeu%20nome%20%C3%A9%20Greice,%20falo%20da%20Edy%20Planejados.%0AEsse%20contato%20%C3%A9%20em%20resposta%20ao%20seu%20pedido%20de%20or%C3%A7amento%20atrav%C3%A9s%20do%20nosso%20site%20www.edyplanejados.com.br%0APodemos%20seguir%20com%20o%20atendimento%20atrav%C3%A9s%20do%20Whatsapp?" class="btn btn-primary" target="_blank">Chamar No Whatsapp</a>
