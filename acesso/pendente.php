...
$sql = "SELECT * FROM cliente ORDER BY usuario_id DESC";
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <table class="table">
								...
								{
                                    if($user_data['statusvenda'] == 'pendente'){
									echo "<tr>";
                                    echo "<td>".$user_data['usuario_id']."</td>";
                                    echo "<td>".$user_data['nome']."</td>";
                                    echo "<td>".$user_data['telefone']."</td>";
                                    echo "<td>".$user_data['cep']."</td>";
                                    echo "<td>".$user_data['ambientes']."</td>";
                                    echo "<td>".$user_data['valor']."</td>";
                                    echo "<td>".$user_data['observacao']."</td>";
                                    echo "<td>".$user_data['statusvenda']."</td>";
                                    echo "<td>".$user_data['datacadastro']."</td>";
                                    echo "<td><a class='fa fa-edit' href='edite.php?id=$user_data[usuario_id]'></i> </td>";
                                }
								}
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="">KHAPH Sistemas</a>, Todos os Direitos Reservados
                        </div>
