      ...
      <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="painel.php" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i  href='painel.php'></i> KHAPH v1.0</h3>
                </a>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Cadastro Usuario</h6>  
                        ...
                        <div class="form-floating mb-4">
                            <input type="hidden" class="form-control" name="status" value="ATIVO" >
                           
                        </div>
                        
                         <select class="form-select form-select-lg mb-4" name="acesso" aria-label=".form-select-lg example" required>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="www.khaph.com.br">KHAPH Sistemas</a>, Todos Direitos Reservados
                        </div>
